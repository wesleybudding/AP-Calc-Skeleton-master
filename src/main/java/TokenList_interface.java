 ...
 */
interface TokenList_interface {


    /**
     * @pre -
     * @post The token 'token' has been added at the end of the TokenList_interface,
     ...
     * @post The element at location 'index' has been removed, preserving the previous order. The size of the TokenList_interface has been reduced by 1.
     */
